...
import static id.or.qodr.jadwalkajian.home.DetailToday.BASE_URL_IMAGE;

/**
 * Created by adul on 04/08/17.
 */

public class DetailWeek extends AppCompatActivity implements OnMapReadyCallback{
    ...
    private GoogleMap mMap; private UtilsDate utils;
    ...
    public void setDataFromList(){
        ...
        String[] pisah = str_tanggal.split("-");
...
//        }else if (!str_setiap.isEmpty() && !str_pekan.isEmpty()){
        ...
        txt_tanggal.setText(pisah[2]+" "+utils.selectPekan(pisah[1]) + " " +pisah[0]);
        txt_mulai.setText("Pukul "+start[0]+":"+start[1]);
        txt_sampai.setText(ends[0]+":"+ends[1]+ " WIB");
        txt_tema.setText(Html.fromHtml("Judul : "+"<b>"+str_tema+"<b>"));
        txt_pemateri.setText(Html.fromHtml("Pemateri : "+"<b>"+str_pemateri+"<b>"));
